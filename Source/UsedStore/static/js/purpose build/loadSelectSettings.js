...
const userGender = document.getElementById('selectedGender').value;
const userCountry = document.getElementById('selectedCountryText').value;
const userState = document.getElementById('selectedStateText').value;
const userCity = document.getElementById('selectedCityText').value;
