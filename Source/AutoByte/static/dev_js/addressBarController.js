document.addEventListener("DOMContentLoaded", function () {
  ...
  editButtons.forEach(function (button) {
    button.addEventListener("click", function () {
      ...
      var lat = document.querySelector("#hiddenLat"+ index).value;
      var lng = document.querySelector("#hiddenLng"+ index).value;
      ...
      document.getElementById("existingLat").value = lat;
      document.getElementById("existinglng").value = lng;
