...
document.addEventListener('DOMContentLoaded', function () {
    ...
    loadLocation();
    document.getElementById('datetime').addEventListener("input", validateEndDate);
...
function setDateTime() {
    ...
    var tomorrow = currentDate.toISOString().slice(0,16);
    document.getElementById("datetime").min = tomorrow;
}

function validateEndDate() {
    if (biddingdiv.classList.contains('d-none')) {
        console.log("You Have Selected Mannual therefore its true");
        return true;
    }else if(document.getElementById('datetime').value.length == 0){
        console.log("datetime_error");
        document.getElementById('errorEndDate').classList.add('invalid-feedback');
        document.getElementById('datetime').classList.add('is-invalid');
        document.getElementById('errorEndDate').textContent = "Please Select the End Date";
        return false;
    }
    document.getElementById('errorEndDate').classList.remove('invalid-feedback');
    document.getElementById('datetime').classList.remove('is-invalid');
    document.getElementById('errorEndDate').classList.add('valid-feedback');
